	...
	<div class="modal-dialog" role="document">
		<div class="modal-content text-centered">
			<div class="modal-header">
				<h1 class="header-alert"><img class="caution-img" src="../global/images/caution-major.png" alt="Caution!">Drug-Drug Alert</h1>
			</div>
			<div class="modal-body interaction-body">
				<div class="section-wrap">
					<div class="row">
						<div class="column lg-4"><span class="row-label">This medication</span></div>
						<div class="column lg-8"><span class="bold highlight-error">Xyrem (sodium oxybate)</span> <i>interacts with</i></div>
					</div>
					<div class="row">
				...
				<div class="section-wrap section-details severity-section">
					<div class="row">
						...
						<div class="column lg-8"><span class="bold severity-value major">Major</span></div>
					</div>
					<div class="row">
						<div class="column lg-4"><span class="row-label">Details</span></div>
						<div class="column lg-8"><p>CONTRAINDICATED: The central nervous system and respiratory depressant effects of sodium oxybate, which is the sodium salt of gamma hydroxybutyrate (GHB), may be potentiated by concomitant use of sedative-hypnotic agents. An increased risk of serious adverse reactions such as respiratory depression, hypotension, profound sedation, syncope, coma, and even death should be anticipated.</p></div>
					</div>
				</div>
