	...
	<div class="modal-dialog" role="document">
		<div class="modal-content text-centered">
			<div class="modal-header">
				<h1 class="header-alert"><img class="caution-img" src="../global/images/caution.png" alt="Caution!">Drug-Drug Alert</h1>
			</div>
			<div class="modal-body interaction-body">
				<div class="section-wrap">
					<div class="row">
						<div class="column lg-4"><span class="row-label">This medication</span></div>
						<div class="column lg-8"><span class="bold highlight-error">Hylenex Solution</span> <i>interacts with</i></div>
					</div>
					<div class="row">
				...
				<div class="section-wrap section-details severity-section">
					<div class="row">
						...
						<div class="column lg-8"><span class="bold severity-value minor">Minor</span></div>
					</div>
					<div class="row">
						<div class="column lg-4"><span class="row-label">Details</span></div>
						<div class="column lg-8"><p>Larger amounts of hyaluronidase may be required to achieve equivalent dispersing effects if patients are concomitantly receiving large doses of salicylates, cortisone, ACTH, estrogens, or antihistamines. These drugs may render tissues partially resistant to the dispersing action of hyaluronidase.</p></div>
					</div>
				</div>
