<div class="flow-section">
	...
	<div class="fieldgroup">
		...
		<div class="error-msg-wrapper lg-4 <?php if ($fail == "true"){ echo "has-error"; } ?>">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text" placeholder="last name" name="last-name" value="<?php echo $lastName ?>">
			<div class="error-msg <?php if ($fail == "true"){ echo "show"; } ?>">Last name is required.</div>
		</div>
		<div class="error-msg-wrapper lg-4">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text optional" placeholder="middle name" name="middle-name" value="<?php echo $middleName ?>">
			<!--div class="error-msg <?php if ($fail == "true"){ echo "show"; } ?>">Middle name is required.</div-->
		</div>
	</div>
	<div class="error-msg-wrapper lg-12 has-icon <?php if ($fail == "true"){ echo "has-error"; } ?>">
		...
		<icon class="icon-home nofocus-icon"></icon><icon class="icon-home hasfocus-icon"></icon>
		<div class="error-msg <?php if ($fail == "true"){ echo "show"; } ?>">Address is required.</div>
	</div>
	<div class="fieldgroup">
		<div class="error-msg-wrapper lg-4 <?php if ($fail == "true"){ echo "has-error"; } ?>">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text" placeholder="city" name="city" value="<?php echo $city ?>">
			<div class="error-msg <?php if ($fail == "true"){ echo "show"; } ?>">City is required.</div>
		</div>
		<div class="error-msg-wrapper select-wrapper lg-4 <?php if ($fail == "true"){ echo "has-error"; } ?> <?php if ($state !== ""){ echo "selected"; } ?>">
		...
		<div class="error-msg-wrapper lg-4 <?php if ($fail == "true"){ echo "has-error"; } ?>">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="5" class="form-text" placeholder="zip code" name="zip code" value="<?php echo $zipCode ?>">
			<div class="error-msg <?php if ($fail == "true"){ echo "show"; } ?>">Zip code is required.</div>
		</div>
	</div>
	<div class="fieldgroup">
		<div class="error-msg-wrapper lg-4 <?php if ($fail == "true"){ echo "has-error"; } ?>">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text" id="patient-birthday" placeholder="birthday" name="birthday"  value="<?php echo $birthday ?>">
			<div class="error-msg <?php if ($fail == "true"){ echo "show"; } ?>">Birthday is required.</div>
		</div>
		<div class="error-msg-wrapper select-wrapper lg-4 <?php if ($fail == "true"){ echo "has-error"; } ?> <?php if ($gender !== ""){ echo "selected"; } ?>">
			<select class="form-text">
		...
		<div class="input-wrapper has-controls weight lg-4">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text optional" placeholder="weight" name="weight" value="<?php echo $weight ?>">
			<div class="control">
				<span>lbs</span>
			</div>
		</div>
...
<div class="flow-section">
	...
	<div class="fieldgroup">
		<div class="input-wrapper lg-4 has-icon">
			<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text optional field-icon" id="patient-phone" placeholder="phone" name="phone" value="<?php echo $phone ?>">
			<icon class="icon-smartphone nofocus-icon"></icon><icon class="icon-smartphone hasfocus-icon"></icon>
		</div>
		<div class="input-wrapper lg-8 has-icon">
			<input type="email" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="254" class="form-text optional field-icon" placeholder="email" name="email" value="<?php echo $email ?>">
			<icon class="icon-mail nofocus-icon"></icon><icon class="icon-mail hasfocus-icon"></icon>
		</div>
	</div>
</div>