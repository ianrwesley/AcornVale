				...
				<div class="column lg-6">
					<header>
						<div class="header-wrap">
							<h1 class="cs-configure-title">Customize your Clara Pro CS plan</h1>
						</div>
						...
						<div class="cs-configuration-selections">
							<div class="cs-configuration-category">
								...
								<div class="cs-configuration-optiongroup">
									<h3 class="cs-option-title">Pro CS licenses</h3>
								...
								<div class="cs-configuration-optiongroup">
									<h3 class="cs-option-title">Pro licenses</h3>
								...
								<div class="cs-configuration-optiongroup">
									<h3 class="cs-option-title">Basic licenses</h3>
