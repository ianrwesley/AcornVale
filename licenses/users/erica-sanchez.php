...
$userID = "esanchez@wcch.com";
$userPhone = "+1 (337) 528-4715"
?>
											...
											<div class="user-account-details clearfix">
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><a href="../facilities/west-calcasieu-cameron-hospital.php">West Calcasieu Cameron Hospital</a></div>
													</div>
													<div class="column large-5">
														...
														<table class="no-wrap table users">
															...
															<tbody>
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">West Calcasieu Cameron Hospital</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">WCCH-0</a></div>
																	</td>
													...
													<div class="column large-10">
														...
														<div class="row">
															...
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/west-calcasieu-cameron-hospital.php">West Calcasieu Cameron Hospital</a></li>
																	</ul>
																</div>
															</div>
														</div>
