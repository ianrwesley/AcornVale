...
$userDesignation = "Dr.";
$userFirstName = "Luis";
$userLastName = "Alfonso";
$userName = "$userDesignation $userFirstName $userLastName";
$userID = "dr.luis.alfonso@palmspringshospital.org";
$userPhone = "+1 (305) 558-2500";
$providerNPI = "1730331943";
													...
													<div class="column large-10">
														...
														<div class="row">
															...
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/larkin-community-hospital-palm-springs.php">Larkin Community Hospital (Palm Springs)</a></li>
																	</ul>
																</div>
															</div>
														</div>
														...
														<table class="no-wrap table users">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">Larkin Community Hospital (Palm Springs)</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">LCH-PS-0</a></div>
																	</td>
																	<td class="col-user-last-login col-small">
