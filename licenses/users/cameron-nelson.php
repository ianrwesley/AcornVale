<?php
$userDesignation = "Dr.";
$userFirstName = "Cameron";
$userLastName = "Nelson";
$userName = "$userDesignation $userFirstName $userLastName";
$userID = "drcam1@mac.com";
$userPhone = "+1 (765) 348-0300";
$providerNPI = "1932488053";
$providerDEA = "CB1234562";
$providerPrescribingPrivileges = "Schedule II";
?>
		...
		<div class="manage facility">
			...
			<div class="container">
				<account>
										...
										<div class="accordian-fade">
											<div class="user-account-details clearfix">
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><a href="../facilities/adams-memorial-hospital.php">Adams Memorial Hospital</a></div>
													</div>
													<div class="column large-5">
														<h3 class="section-subtitle">PROVIDER</h3>
														<div class="key-owner profile-value">Yes</div>
													</div>
												</div>
											</div>
											<div class="editable user-account-edit clearfix">
														...
														<table class="no-wrap table users">
															<thead>
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<h3 class="section-subtitle">FACILITY NAME</h3><span class="sort none"></span>
																	</td>
															...
															<tbody>
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">Adams Memorial Hospital</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">AMH-0</a></div>
																	</td>
																...
																<tr>
																	<td colspan="4">
																		<div class="button-group">
																			...
																			<button type="button" class="button button-link button-compact subdued" disabled="">Remove Privileges</button>
																		</div>
																	</td>
																</tr>
															</tfoot>
												...
												<div class="row edit-row">
													...
													<div class="column large-5 small-12">
														<div class="description"><?php echo $userName; ?> is a provider. They can access Teach, Treat and Transfer.</div>
													</div>
												</div>
											</div>
											</div>
					...
					<section id="facilities" class="flow-section flow-section-border">
						<div class="facilities-wrapper">
							<div class="row">
								<div class="column large-3 medium-12">
									<h2 class="section-title mobile-edit">Facilities</h2>
								</div>
								<div class="column large-9 medium-12 facilities-content">
									<accordian class="closed">
										<div class="accordian-fade">
														...
														<div class="row">
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/adams-memorial-hospital.php">Adams Memorial Hospital</a></li>
																	</ul>
																</div>
															</div>
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/bay-area-regional-medical-center.php">Bay Area Regional Medical Center</a></li>
																	</ul>
																</div>
															</div>
														</div>
											...
											<div class="editable facilities-edit clearfix">
												<div class="editable-header mobile-only">
														...
														<table class="no-wrap table users">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">Bay Area Regional Medical Center</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">BARMC-0</a></div>
																	</td>
																	<td class="col-user-last-login col-small">
																		<div class="col-value">3/21/17&nbsp;&nbsp;07:41 am</div>
																	</td>
																</tr>
															</tbody>
															<tfoot>
					...
					<section id="provider" class="flow-section flow-section-border">
						<div class="provider-wrapper">
							<div class="row">
								<div class="column large-3 medium-12">
									<h2 class="section-title mobile-edit">Provider</h2>
								</div>
								<div class="column large-9 medium-12 provider-content">
									<accordian class="closed">
										<div class="accordian-fade">
											<div class="provider-details clearfix">
												<div class="row">
													<div class="column large-5">
														...
														<div class="profile-value"><?php echo $providerNPI; ?></div>
													</div>
													<div class="column large-5">
														<h3 class="section-subtitle">PRESCRIBING PRIVILEGES</h3>
														<div class="profile-value"><?php echo $providerPrescribingPrivileges; ?></div>
													</div>
													<div class="column large-2 section-edit">
														<button class="button button-link button-compact button-edit" onclick="editSection()">Edit</button>
													</div>
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><?php echo $providerDEA; ?></div>
													</div>
												</div>
											</div>
											<div class="editable provider-edit clearfix">
												<div class="editable-header mobile-only">
													<h2 class="mobile-section-title">Provider</h2>
													<button class="button button-flat button-done button-done-mobile">Done</button>
												</div>
												<div class="mobile-section-wrap">
													<div class="row edit-row">
														<div class="column large-5 small-12">
															<h3 class="section-subtitle">NPI NUMBER</h3>
															<div class="rescue-number"><?php echo $providerNPI; ?></div>
															<button class="button button-link"> Change NPI Number… </button>
														</div>
														<div class="column large-5 small-12">
															<div class="description">The provider's NPI number…</div>
														</div>
														<div class="column large-2 section-edit">
														<button class="button button-flat button-done" onclick="saveSection()">Save</button>
													</div>
													...
													<div class="row edit-row">
														<div class="column large-5 small-12">
															<h3 class="section-subtitle">DEA NUMBER</h3>
															<div class="rescue-number"><?php echo $providerDEA; ?></div>
															<button class="button button-link"> Change DEA Number… </button>
														</div>
														<div class="column large-5 small-12">
															<div class="description">The provider's DEA number…</div>
														</div>
													</div>
													<div class="row edit-row">
														<div class="column large-5 small-12">
															<h3 class="section-subtitle">PRESCRIBING PRIVILEGES</h3>
															<div class="rescue-number"><?php echo $providerPrescribingPrivileges; ?></div>
															<button class="button button-link"> Change Prescribing Privileges… </button>
														</div>
														<div class="column large-5 small-12">
															<div class="description">The provider's prescribing privileges…</div>
														</div>
													</div>
												</div>
											</div>
