<?php
$userFirstName = "Conner";
$userLastName = "Brosnahan";
$userName = "$userFirstName $userLastName";
$userID = "cbrosnahan@snch.org";
$userPhone = "+1 (516) 632-3186"
?>
											...
											<div class="user-account-details clearfix">
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><a href="../facilities/south-nassau-communities-hospital.php">South Nassau Communities Hospital</a></div>
													</div>
													<div class="column large-5">
														...
														<table class="no-wrap table users">
															...
															<tbody>
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">South Nassau Communities Hospital</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">SNCH-0</a></div>
																	</td>
													...
													<div class="column large-10">
														...
														<div class="row">
															...
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/south-nassau-communities-hospital.php">South Nassau Communities Hospital</a></li>
																	</ul>
																</div>
															</div>
														</div>
