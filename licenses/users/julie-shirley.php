<?php
$userFirstName = "Julie";
$userLastName = "Shirley";
$userName = "$userFirstName $userLastName";
$userID = "jshirley@barmc.us";
$userPhone = "+1 (281) 525-6753"
?>
											...
											<div class="user-account-details clearfix">
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><a href="../facilities/bay-area-regional-medical-center.php">Bay Area Regional Medical Center</a></div>
													</div>
													<div class="column large-5">
																		...
																		<div class="popover popover-direction-bottom popover-align-center popover-type-action">
																			<div class="popover-inner-content">
																				<div class="step-content" id="step-1">
																						...
																						<div class="details">
																							<div class="flow-label"><strong class="warning">Did you confirm with <?php echo $userName; ?> that she wants to change her email?</strong> The user will need to confirm their new email address before their Clara ID can be changed.</div>
																						</div>
																				</div>
																	...
																	<td colspan="4">
																		<div class="button-group">
																			<div class="pop-wrapper" id="popwrapper-2">
																				<div class="col-value"><button type="button" class="button button-link button-compact open-popover-link button-add-icon">Assign Super User Privileges…</button></div>
																				<div class="popover-content">
													...
													<div class="column large-10">
														...
														<div class="row">
															...
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li class="designated-super-user"><a href="../facilities/bay-area-regional-medical-center.php">Bay Area Regional Medical Center</a></li>
																	</ul>
																</div>
															</div>
														</div>
														...
														<table class="no-wrap table users">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value designated-super-user"><a role="link">Bay Area Regional Medical Center</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">BARMC-0</a></div>
																	</td>
																...
																<tr>
																	...
																	<td class="col-user-last-login col-small">
																		<div class="col-value">3/18/17&nbsp;&nbsp;04:32 pm</div>
																	</td>
																</tr>
															</tbody>
															<tfoot>
																<tr>
																	<td colspan="4">
																		<div class="button-group">
																			<div class="pop-wrapper" id="popwrapper-2">
																				<div class="col-value"><button type="button" class="button button-link button-compact open-popover-link button-add-icon">Grant Access to Facility…</button></div>
																				<div class="popover-content">
																					<div class="popover-container" id="popover-2">
