...
$userID = "emetz@lapazhospital.org";
$userPhone = "+1 (928) 669-7401"
?>
											...
											<div class="user-account-details clearfix">
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><a href="../facilities/la-paz-regional-hospital.php">La Paz Regional Hospital</a></div>
													</div>
													<div class="column large-5">
														...
														<table class="no-wrap table users">
															...
															<tbody>
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">La Paz Regional Hospital</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">LPRH-0</a></div>
																	</td>
														...
														<div class="row">
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/la-paz-regional-hospital.php">La Paz Regional Hospital</a></li>
																	</ul>
																</div>
															</div>
														</div>
