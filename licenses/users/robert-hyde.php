...
$userID = "robert.hyde@newlondonhospital.org";
$userPhone = "+1 (419) 592-4015";
$providerNPI = "1811173347";
													...
													<div class="column large-10">
														...
														<div class="row">
															...
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/henry-county-hospital.php">New London Hospital</a></li>
																	</ul>
																</div>
															</div>
														</div>
														...
														<table class="no-wrap table users">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">New London Hospital</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">NLH-0</a></div>
																	</td>
																	<td class="col-user-last-login col-small">
