<?php
$userFirstName = "Rhondee";
$userLastName = "Damon";
$userName = "$userFirstName $userLastName";
$userID = "rhondeedamon@gmail.com";
$userPhone = "+1 (713) 527-4400"
?>
											...
											<div class="user-account-details clearfix">
												...
												<div class="row">
													<div class="column large-5">
														...
														<div class="super-user profile-value"><a href="../facilities/elite-care-emergency-room-of-plano.php">Elite Care Emergency Room of Plano</a></div>
													</div>
													<div class="column large-5">
														...
														<table class="no-wrap table users">
															...
															<tbody>
																<tr>
																	...
																	<td class="col-facility-name col-large">
																		<div class="col-value"><a role="link">Elite Care Emergency Room of Plano</a></div>
																	</td>
																	<td class="col-facility-id col-small">
																		<div class="col-value"><a role="link">ECEROP-0</a></div>
																	</td>
														...
														<div class="row">
															<div class="column large-6">
																<div class="profile-value">
																	<ul>
																		<li><a href="../facilities/elite-care-emergency-room-of-plano.php">Elite Care Emergency Room of Plano</a></li>
																	</ul>
																</div>
															</div>
														</div>
