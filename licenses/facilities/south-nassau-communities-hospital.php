<?php
$facilityName = "South Nassau Communities Hospital";
$facilityID = "SNCH-0";
?>
																	...
																	<ul class="profile-value-list">
																		<li>
																			<div class="pop-wrapper">
																				<div class="col-value designated-super-user"><button class="button button-link facility-super-user-link open-popover-link">Conner Brosnahan</button></div>
																				<div class="popover-content">
																									...
																									<div class="step-content">
																										<div class="pop-wrapper field-pop-wrapper">
																											<div class="details">
																												...
																												<div class="popover-details">Clara ID: <span><a href="mailto:cbrosnahan@snch.org">cbrosnahan@snch.org</a></span></div>
