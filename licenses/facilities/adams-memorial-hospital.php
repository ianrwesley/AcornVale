<?php
$facilityName = "Adams Memorial Hospital";
$facilityID = "AMH-0";
?>
...
<body>
																	...
																	<ul class="profile-value-list">
																		<li>
																			<div class="pop-wrapper">
																				<div class="col-value"><button class="button button-link facility-super-user-link open-popover-link">Julie Shirley</button></div>
																				<div class="popover-content">
															...
															<div class="column large-6">
																<div class="profile-value">
																	<ul class="profile-value-list">
																		<li>
																			<div class="pop-wrapper">
																				<div class="col-value designated-super-user"><button class="button button-link facility-super-user-link open-popover-link">Dr. Cameron Nelson</button></div>
																				<div class="popover-content">
																					<div class="popover-container">
																						<div class="popover-wrapper popover-wrapper-direction-bottom popover-wrapper-align-center narrow popover-inline">
																							<div class="popover popover-direction-bottom popover-align-center popover-type-action">
															...
															<table class="no-wrap table users">
																...
																<tbody>
																	<tr>
																		...
																		<td class="col-user-name col-large">
																			<div class="col-value"><a>Julie Shirley</a></div>
																		</td>
																		<td class="col-user-id col-small">
															...
															<table class="no-wrap table users">
																...
																<tbody>
																	<tr>
																		...
																		<td class="col-user-name col-large">
																			<div class="col-value designated-super-user"><a>Dr. Cameron Nelson</a></div>
																		</td>
																		<td class="col-user-id col-small">
	...
	<div style="position:fixed; top:170px; left:50%; width:72px; margin-left:-30px; z-index:99999;">
		<img src="../../global/images/animation/loading.gif" style="display:inline-block; vertical-align:middle; margin-right:12px;">
		<div class="animated-loading-wrapper" style="display:inline-block; vertical-align:middle;">
			<span class="animated-loading-circle loading-circle-1"></span>
			<span class="animated-loading-circle loading-circle-2"></span>
			<span class="animated-loading-circle loading-circle-3"></span>
			<span class="animated-loading-circle loading-circle-4"></span>
			<span class="animated-loading-circle loading-circle-5"></span>
			<span class="animated-loading-circle loading-circle-6"></span>
			<span class="animated-loading-circle loading-circle-7"></span>
		</div>
	</div>
</body>
