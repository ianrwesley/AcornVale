<?php
$facilityName = "Elite Care Emergency Room of Plano";
$facilityID = "ECEROP-0";
?>
																	...
																	<ul class="profile-value-list">
																		<li>
																			<div class="pop-wrapper">
																				<div class="col-value designated-super-user"><button class="button button-link facility-super-user-link open-popover-link">Rhondee Damon</button></div>
																				<div class="popover-content">
																							...
																							<div class="popover popover-direction-bottom popover-align-center popover-type-action">
																								<div class="popover-inner-content">
																									<div class="step-content">
																										<div class="pop-wrapper field-pop-wrapper">
																											<div class="details">
																												<h2 class="superuser-name popover-details">Rhondee Damon</h2>
																												<div class="popover-details">Clara ID: <span><a href="mailto:rhondeedamon@gmail.com">rhondeedamon@gmail.com</a></span></div>
																												<div class="popover-details">Rescue Mobile Number: <span>+1 (713) 527-4400</span></div>
																											</div>
																										</div>
																									</div>
																									<div class="step-footer clearfix">
																										<div class="toolbar-footer clearfix">
																											<div class="button-group">
																												...
																												<button tabindex="0" type="button" class="button button-link first nav-action pull-right"><a href="../users/rhondee-damon.php">Go To Profile</a></button>
																											</div>
																										</div>
																									</div>
																								</div>
															...
															<table class="no-wrap table users">
																...
																<tbody>
																	<tr>
																		...
																		<td class="col-user-name col-large">
																			<div class="col-value"><a>Rhondee Damon</a></div>
																		</td>
																		<td class="col-user-id col-small">
